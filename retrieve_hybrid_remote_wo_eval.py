...
def main():
    ...
    input_file_name = "/home/samsung/haoquan/BioASQ-task13bPhaseA-testset2.json"
    ...
    output_filepath = f"/home/samsung/haoquan/bioasq2024-main/02_12B/Batch1/PhaseA/Results/Evaluation/{timestamp}_{model_name_pretty}_12B2_PhaseA_{n_shot}-Shot.csv"
    # print(output_filepath)
    os.makedirs(os.path.dirname(output_filepath), exist_ok=True)
    questions_df.to_csv(output_filepath, index=False)

    # json_filepath = os.path.splitext(output_filepath)[0] + ".json"
    json_filepath = os.path.splitext(output_filepath)[0] + "_13b_batch2_phaseA.json"
